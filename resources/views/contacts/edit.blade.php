                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <select name="age">
                                                    ...
                                                    <option value="3"
                                                        @if ($contact->age === 3) selected @endif>3０歳〜3９歳
                                                    </option>
                                                    <option value="4"
                                                        @if ($contact->age === 4) selected @endif>4０歳〜4９歳
                                                    </option>
                                                    <option value="5"
                                                        @if ($contact->age === 5) selected @endif>5０歳〜5９歳
                                                    </option>
                                                    <option value="6"
                                                        @if ($contact->age === 6) selected @endif>6０歳〜</option>
                                                </select>
