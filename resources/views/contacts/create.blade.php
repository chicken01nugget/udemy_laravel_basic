                                ...
                                <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                <label for="title"
                                                    class="leading-7 text-sm text-gray-600title">件名</label>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <select name="age">
                                                    ...
                                                    <option value="1" {{ old('age') == 1 ? 'selected' : '' }}>〜１９歳</option>
                                                    <option value="2" {{ old('age') == 2 ? 'selected' : '' }}>２０歳〜２９歳</option>
                                                    <option value="3" {{ old('age') == 3 ? 'selected' : '' }}>3０歳〜3９歳</option>
                                                    <option value="4" {{ old('age') == 4 ? 'selected' : '' }}>4０歳〜4９歳</option>
                                                    <option value="5" {{ old('age') == 5 ? 'selected' : '' }}>5０歳〜5９歳</option>
                                                    <option value="6" {{ old('age') == 6 ? 'selected' : '' }}>6０歳〜</option>
                                                </select>
